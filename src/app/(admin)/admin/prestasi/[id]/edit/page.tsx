        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-extrabold text-gray-900">Edit Prestasi</h1>
                    <p className="text-gray-600 mt-1">Update data prestasi dan penghargaan</p>
                </div>

                <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
                    <PrestasiForm prestasi={prestasi} />
                </div>
            </div>
        </div>
    );
